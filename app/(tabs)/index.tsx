    ...
    <SafeAreaView className='flex-1 bg-secondary/30'>
      ...
      <Card className='w-full max-w-sm p-6 rounded-2xl'>
        <CardHeader className='items-center'>
          ...
          <View className='p-3' />
          <CardTitle className='pb-2 text-center'>Welcome Home</CardTitle>
          <View className='flex-row'>
            <CardDescription className='text-base font-semibold'>Dashboard</CardDescription>
            <Tooltip delayDuration={150}>
              <TooltipTrigger className='px-2 pb-0.5 active:opacity-50'>
                <Info size={14} strokeWidth={2.5} className='w-4 h-4 text-foreground/70' />
              </TooltipTrigger>
              <TooltipContent className='py-2 px-4 shadow'>
                <Text className='native:text-lg'>Main Hub</Text>
              </TooltipContent>
            </Tooltip>
          </View>
        </CardHeader>
        <CardContent>
          <View className='flex-row justify-around gap-3'>
            ...
            <View className='items-center'>
              ...
              <Text className='text-xl font-semibold'>28</Text>
            </View>
          </View>
        </CardContent>
